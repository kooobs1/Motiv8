...
class ProductLine
{
	...
	private class func iDevices() -> ProductLine {
		...
		products.append(Product(titled: "Jamba Juice", description: "Jamba! Enriching the daily experience of our customers, our community and ourselves through the life-nourishing qualities of fruits and vegetables.", imageName: "Jamba-Juice.jpg"))
		products.append(Product(titled: "Nutrishop", description: "It is NUTRISHOP’S mission to help you succeed in all your health and fitness goals and aspirations.  Whether your goal is, weight loss, muscle growth, to tone-up, increase energy levels, improve general health or to simply look and feel better, we have what you are looking for.", imageName: "ns-logo.jpg"))
		products.append(Product(titled: "Sports Authority", description: "Our customers are passionate about the sports they pursue—they want to run faster, jump higher, hit the ball harder, carry their team to victory, and more. We understand the passion that comes with being dedicated to a goal.", imageName: "sportsauthority.png"))
